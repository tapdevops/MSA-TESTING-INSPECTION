...
*/
	...
	// const InspectionTrackingModel = require( _directory_base + '/app/v2.0/Http/Models/InspectionTrackingModel.js' );
                    ...
                    data.forEach( async function( dt ) {
                        ...
                        .then( async ( summary ) => {
                            if( !summary ) {
                                ...
                                console.log( 'data summary dengan user authcode pada tanggal ini sudah ada' );
                            }
                        } )
